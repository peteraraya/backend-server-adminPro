...
function buscarHospitales(busqueda, regex) {
    ...
    return new Promise((resolve, reject) => {
        ...
        Hospital.find({ nombre: regex })
            .populate('usuario', 'nombre email') // que usuario creo que hospital
            .exec((err, hospitales) => {
...
function buscarUsuarios(busqueda, regex) {
    ...
    return new Promise((resolve, reject) => {
        ...
        Usuario.find({}, 'nombre email role') // envio un string con los campos que quiero y evito enviar el passwopr
